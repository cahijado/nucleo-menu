...
export const DICCIONARIO = [
  ...
  [/salsa de pescado|nam pla|nuoc mam/, "salsa_pescado"],
  [/salsa de ostras/, "salsa_ostras"],
  ...
  // antes que el vinagre a secas, o "crema de balsámico" acabaría siendo vinagre
  [/crema (?:de vinagre )?balsamic[ao]|reducci[óo]n de balsamic[ao]|glaseado de balsamic[ao]/, "crema_balsamico"],
  ...
  [/oporto|pedro ximenez|px|moscatel|vino dulce|jerez|vino rancio|marsala|mistela|mirin|madeira|oloroso|vermut/, "vino_dulce"],
  [/brandy|conac|cognac|whisky|\bron\b|orujo|licor|curacao/, "brandy"],
  [/cerveza/, "cerveza"],
  [/sidra/, "vino_blanco"],
  ...
  [/buey picad|picada de buey/, "buey_picada"],
  ...
  // el buey de mar (marisco) ya está resuelto más abajo; aquí solo la carne
  [/\bbuey\b(?!\s*de\s*mar)/, "buey"],
  ...
  [/canonigo/, "canonigos"],
  [/berro/, "berros"],
  [/hojas variadas.*ensalada|mezclum|mezcla de lechugas|ensalada variada/, "mezclum"],
  [/lechuga|escarola|cogollo/, "lechuga"],
  [/brotes/, "brotes"],
  ...
  [/pak choi|pakchoi|bok choy|col china/, "col_china"],
  [/menestra/, "menestra_verduras"],
  [/wakame/, "alga_wakame"],
  ...
  [/alubia|judia blanca|judia roja|judia negra|judias?\b|judion|faba|fabe|pocha|frijol|caraota|poroto/, "alubias"],
  [/tofu/, "tofu"],
  ...
  [/pan de hamburguesa|panes de hamburguesa|pan para hamburguesa/, "pan_hamburguesa"],
  [/pan pita|panes pita|pan de pita|pan de pitta/, "pan_pita"],
  [/pan de molde|pan asentado|pan duro|pan candeal|pan de telera|barra de pan|baguettes?\b|rebanada de pan|pan frito|pan del dia|slice de pan|sopako|hogaza|pan$|picatoste/, "pan_trigo"],
  ...
  [/pasta de curry|pasta curry/, "especias"],
  ...
  [/levadura quimica|polvo de hornear|impulsor|royal|gasificante/, "levadura_quimica"],
  ...
  [/laurel|tomillo|romero|oregano|mejorana|epazote/, "hierbas"],
  ...
  [/pimenton|pimienta|comino|azafran|curry|curcuma|\bclavos?\b|jengibre|galanga|nuez moscada|\bespecias?\b|colorante|\banis\b|cayena|pimenta|zumaque|cardamomo|bayas de enebro|enebro/, "especias"],
